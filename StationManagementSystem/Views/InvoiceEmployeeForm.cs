...
{
    public partial class InvoiceEmployeeForm : Form
    {
        private Account _account;
        private Employee _employee;
        private string _roleName;
        public InvoiceEmployeeForm()
        {
            InitializeComponent();
        }
        public InvoiceEmployeeForm(Account account, Employee employee, string roleName)
        {
            InitializeComponent();
        ...
        {
            //CreateFormChild(new DepartureOrderList());
        }
        ...
        private void pnTaiKhoan_Paint(object sender, PaintEventArgs e)
        {
