namespace StationManagementSystem.Views.Employees
{
    partial class EmloyeeList
    {
        ...
        private void InitializeComponent()
        {
            ...
            gridView.Columns.AddRange(new DataGridViewColumn[] { CustomerName, ID, Gender, PhoneNumber, Email, DateOfBirth, UserName, Active, Amount });
            ...
            DateOfBirth.SortMode = DataGridViewColumnSortMode.Programmatic;
            // 
            // UserName
            // 
